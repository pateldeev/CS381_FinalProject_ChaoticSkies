...
void AspectPhysics2D::Tick(float dt) {
	...
	m_entity->m_velocity.x = Ogre::Math::Cos(Ogre::Degree(m_entity->m_heading)) * m_entity->m_speed;
	m_entity->m_velocity.z = -Ogre::Math::Sin(Ogre::Degree(m_entity->m_heading)) * m_entity->m_speed;
